    ...
    )
{
    ...
    case WMTHWVER_MT6620_E5:
        filp = filp_open("/vendor/firmw/"CFG_FW_FILENAME, O_RDONLY, 0);
        break;

    case WMTHWVER_MT6620_E6:
    default:
        filp = filp_open("/vendor/firmw/"CFG_FW_FILENAME"_E6", O_RDONLY, 0);
        break;
    }
#elif defined(MT5931) && CFG_MULTI_ECOVER_SUPPORT
    ...
    case HWVER_MT5931_E2:
        filp = filp_open("/vendor/firmw/"CFG_FW_FILENAME"_E2", O_RDONLY, 0);
        break;
...
#elif defined(MT6628)
//    filp = filp_open("/vendor/firmw/"CFG_FW_FILENAME"_MT6628", O_RDONLY, 0);
//    filp = filp_open("/vendor/firmw/"CFG_FW_FILENAME"_MT6582", O_RDONLY, 0);
	kalMemZero(aucFilePath, sizeof(aucFilePath));
	kalMemCopy(aucFilePath, "/vendor/firmw/"CFG_FW_FILENAME"_",
		strlen("/vendor/firmw/"CFG_FW_FILENAME"_"));
	glGetChipInfo(prGlueInfo, &aucFilePath[strlen("/vendor/firmw/"CFG_FW_FILENAME"_")]);
